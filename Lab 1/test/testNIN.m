...
%   Acquire, plot, and log I-V (current-voltage) data for an NIN junction.
%%%%%%%%%%%%%%%%%%%%
...
timeStamp = clock;
fix(timeStamp);
truncated_image_file_forward = sprintf('%d%d%d-%d%d-NIN-IV-Forward-Plot-%d.png',timeStamp(1),timeStamp(2),timeStamp(3),timeStamp(4),timeStamp(5),junction);
...
%%%%%%%%%%%%%%%%%%%%
truncated_file_name_forward = sprintf('%d%d%d-%d%d-NIN-IV-Forward-%d.txt',timeStamp(1),timeStamp(2),timeStamp(3),timeStamp(4),timeStamp(5),junction);
...
timeStamp = clock;
fix(timeStamp);
truncated_image_file_backward = sprintf('%d%d%d-%d%d-NIN-IV-Backward-Plot-%d.png',timeStamp(1),timeStamp(2),timeStamp(3),timeStamp(4),timeStamp(5),junction);
...
% Save the current output and voltage outputs in a text file with a timestamp
%%%%%%%%%%%%%%%%%%%%
truncated_file_name_backward = sprintf('%d%d%d-%d%d-NIN-IV-Backward-%d.txt',timeStamp(1),timeStamp(2),timeStamp(3),timeStamp(4),timeStamp(5),junction);
